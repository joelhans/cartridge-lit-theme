  ...
  <div class="container">
    ...
    <article class="<?php echo $post->post_name; ?>">
      ...
      <?php if ( $post->post_name == "now-a-note-on-the-world-economy" ) : ?>
        ...
        <!--
        <img class="soul-2-1" data-stellar-ratio="2.1763" src="<?php echo $chap_path; ?>soul_2.png" />
        <img class="soul-2-2" data-stellar-ratio="4.371" src="<?php echo $chap_path; ?>soul_2.png" />
        <img class="soul-3-1" data-stellar-ratio="4.182" src="<?php echo $chap_path; ?>soul_3.png" />
        <img class="soul-4-1" data-stellar-ratio="1.976" src="<?php echo $chap_path; ?>soul_4.png" />
        <img class="soul-4-2" data-stellar-ratio="2.973" src="<?php echo $chap_path; ?>soul_4.png" />
        <img class="soul-4-3" data-stellar-ratio="1.236" src="<?php echo $chap_path; ?>soul_4.png" />
        <img class="soul-5-1" data-stellar-ratio="3.631" src="<?php echo $chap_path; ?>soul_5.png" /> -->
        <img class="soul-6-1" data-stellar-ratio="5.121" data-stellar-vertical-offset="400" src="<?php echo $chap_path; ?>soul_6.png" />
      <?php endif; ?>
